      ...
      if is_undergraduate == 'y':
        if other_scholarship == 'n':
          ...
          # Throw an error if the candidate does not have five distinctions inclusive of English and Mathematics
            ...
            print("You need at least five distinctions in relevant subjects including English and Mathematics to qualify")
            break
        # Throw an error if candidate is a beneficiary of any other scholarship
        else:
          print("You cannot be a beneficiary of any other scholarship to apply for this one")
          break
      # Throw an error if the candidate is not a full-time undergraduate student in a Nigerian uni
      else:
        break
        print("You need to be a full-time undergraduate student in a Nigerian university to qualify")
    # Thorw an error if the candidate is not even a Nigerian
    else:
      print("You have to be a Nigerian citizen to qualify")
      break
